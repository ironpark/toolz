...
func newArchiveCommand() *ucli.Command {
	return &ucli.Command{
		Name:          "archive",
...
// runArchive moves a completed plan to the last configured plans_dirs
...
func runArchive(_ context.Context, cmd *ucli.Command) error {
	if cmd.NArg() != 1 {

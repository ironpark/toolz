...
func runInitCLI(t *testing.T, arguments ...string) error {
	t.Helper()
...
func TestInitHonoursLanguageAndPlansDirectories(t *testing.T) {
	...
	if err := runInitCLI(t, "--language", "ko", "--plans-dir", "plans-active", "--plans-dir", "plans-archive"); err != nil {
		t.Fatalf("init() unexpected error: %v", err)
	}
...
func TestInitRejectsUnsupportedLanguageBeforeWriting(t *testing.T) {
	...
	if err := runInitCLI(t, "--language", "fr"); err == nil {
...
func TestInitRejectsAbsolutePlansDirectory(t *testing.T) {
	...
	if err := runInitCLI(t, "--plans-dir", "/etc"); err == nil {
...
func TestInitDoesNotOverwriteWithoutForce(t *testing.T) {
	...
	if err := runInitCLI(t, "--force"); err != nil {
...
func TestInitRefusalOutsideARepositoryDoesNotClaimToHaveWritten(t *testing.T) {
	...
	var err error
	stderr := captureStderr(t, func() { err = runInitCLI(t) })
	if err == nil {
...
func TestInitRejectsPositionalArguments(t *testing.T) {
	...
	if err := runInitCLI(t, "somewhere"); err == nil {

...
func newInitCommand() *ucli.Command {
	return &ucli.Command{
		Name:  "init",
...
// runInit writes .planr.yaml and the configured plans directories so a
...
func runInit(_ context.Context, cmd *ucli.Command) error {
	if cmd.NArg() != 0 {

...
- [ ] [Phase 00: JSON-RPC transport over subprocess stdio](phases/00-jsonrpc-transport.md)
...
- [ ] [Phase 05: Approvals and server-initiated requests](phases/05-approvals.md)
